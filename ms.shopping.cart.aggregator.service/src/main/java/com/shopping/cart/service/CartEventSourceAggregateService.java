...
//
//import static com.shopping.cart.service.CartEventSourceAggregator.apply;
//
...
//@Service
//@Log4j2
//@EnableBinding(value = CartEventSourceBinder.class)
//public class CartEventSourceAggregateService {
//
//	@StreamListener(value = "cart-details-input-channel")
//	public void process(KStream<String, String> cartInputStream) {
//
//		cartInputStream.foreach((k, v) -> log.info("Key={}, Value={}", k, v));
//
//		KStream<String, ShoppingCart> shoppingCartKStream = cartInputStream.mapValues(CartEvent::parse)
